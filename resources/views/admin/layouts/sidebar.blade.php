        ...
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="collapse" href="#accountSettings" role="button"
                    ...
                    <span class="link-title">Pengaturan Akun</span>
                    <i class="link-arrow" data-feather="chevron-down"></i>
                </a>
                <div class="collapse" id="accountSettings">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ url('admin/update-admin-password') }}" class="nav-link">Update Password</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('admin/update-admin-details') }}" class="nav-link">Update Detail</a>
                        </li>
                    </ul>
                </div>
            </li>
